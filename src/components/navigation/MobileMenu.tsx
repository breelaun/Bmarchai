...
const MobileMenu = ({ 
  ...
  return (
    <div className="md:hidden">
      <div className="fixed inset-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 overflow-y-auto max-h-screen">
                  ...
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (item.name === "Profile") {
                        // Navigate to profile without using onClick handler
                        return;
                      }
                      item.onClick?.();
                    }}
