...
const MobileMenu = ({ 
  ...
  return (
    <div className="md:hidden fixed inset-0">
      <div className="fixed inset-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-screen overflow-y-auto">
        <div className="min-h-screen px-2 pt-2 pb-3 space-y-1 sm:px-3">
          {menuItems.map((item) => (
