  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex">
      ...
      <div className="w-16 bg-background border-r flex flex-col items-center py-6 space-y-4">
        ...
        <span className="[writing-mode:vertical-lr]">Chat</span>
        <span className="[writing-mode:vertical-lr]">Contacts</span>
        <span className="[writing-mode:vertical-lr]">Online</span>
      </div>
      <Grid>
